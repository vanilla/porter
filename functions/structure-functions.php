...
function vanillaStructure()
{
    ...
    return [
        ...
        "profileField" => [
            ...
            "displayOptions" => "mediumtext",
            "dropdownOptions" => "mediumtext",
            "registrationOptions" => "varchar(255)",
            "sort" => "int(11)",
            "isCoreField" => "varchar(100)",
            "enabled" => "tinyint(4)",
        ],
        "Rank" => [
            "RankID" => "int",
        ...
        "recordStatus" => [
            ...
            "recordSubtype" => "varchar(100)",
            "isDefault" => "tinyint(4)",
            "isSystem" => "tinyint(4)",
            "isInternal" => "tinyint(4)",
            "isActive" => "tinyint(4)",
            "insertUserID" => "int(11)",
            "dateInserted" => "datetime",
            "updateUserID" => "int(11)",
